...
class CatersDataService {
    ...
    static let caters: [Cater] = [
        ...
        Cater(name: "Street cafe",
              ...
              imageNames: ["The street 2"],
              coordinates: CLLocationCoordinate2D(latitude: 51.49830975056084, longitude: -2.5486254036172107),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "The Grill",
              description: "The enthusiasts of piri piri sauce, serving meals bursting with flavour. Located in B block.",
              imageNames: ["The grill"],
              coordinates: CLLocationCoordinate2D(latitude: 51.49923736738787, longitude: -2.548136283499418),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "Starbucks",
              ...
              coordinates: CLLocationCoordinate2D(latitude: 51.500335, longitude: -2.548002),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "Wafflemeister",
              ...
              imageNames: ["Wafflemeister"],
              coordinates: CLLocationCoordinate2D(latitude: 51.500839, longitude: -2.547401),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "The Atrium Café",
              ...
              imageNames: ["The altrium"],
              coordinates: CLLocationCoordinate2D(latitude: 51.500969, longitude: -2.549901),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "The Student Union bar",
              ...
              imageNames: ["The student union bar"],
              coordinates: CLLocationCoordinate2D(latitude: 51.500475, longitude: -2.551564),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "Costa coffee",
              ...
              imageNames: ["costa coffee"],
              coordinates: CLLocationCoordinate2D(latitude: 51.502549, longitude: -2.548453),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        ...
        Cater(name: "Onezone",
              ...
              imageNames: ["Onezone 2"],
              coordinates: CLLocationCoordinate2D(latitude: 51.500358645026026, longitude:  -2.547937697763003),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        
        Cater(name: "Subway",
              description: "Subway serves subs, salads and snacks. Located in Q block.",
              imageNames: ["Subway 2", "Subway 3"],
              coordinates: CLLocationCoordinate2D(latitude: 51.501530, longitude: -2.548678),
              link: "https://www.uwe.ac.uk/life/campus-and-facilities/frenchay-campus/bars-cafes-and-shops#a9ad59644-320c-4470-a5e3-a1467ce82ad1"),
        ...
        Cater(name: "SU Shop",
              ...
              imageNames: ["Student union shop"],
              coordinates: CLLocationCoordinate2D(latitude: 51.50032256782138, longitude: -2.5472879986229615),
              link: "https://www.thestudentsunion.co.uk/commercial-services/shopping/shops/")
